...
export function FreakyShiki() {
  ...
  async function handleChange(event: React.ChangeEvent<HTMLTextAreaElement>) {
    try {
      ...
      const wrappedHtml = codeWrapper({ lang, html });
